...
// Grab data
$sql = "SELECT admin.first_name, SUM(total) AS total
FROM transactions
...
$smarty->assign('title', 'Employee Revenue Report');
$smarty->assign('navTitle', 'Employee Revenue Report');
$smarty->assign('currPage', '<a href="reports.php">Reports</a> / Employee Revenue');
$smarty->display('resources/smarty/templates/employee_revenue.tpl');
?>